...
export default function TwoPanelLayout({
  ...
  return (
    <div className="auth-light flex min-h-screen flex-col overflow-x-clip">
      {/* 全宽背景 — 蓝色渐变 */}
      <div
        className="relative flex flex-1 flex-col lg:flex-row lg:gap-[100px]"
        style={{
          backgroundImage:
            "linear-gradient(180deg, #ffffff 0%, #a5dcf7 30%, #2487ca 70%, #2a7ab8 100%)",
        }}
      >
        {/* 左上角品牌 logo */}
        <a
        ...
        {/* 右上角社交链接（蓝色） */}
        <div className="absolute right-6 top-6 z-20 text-[#2487ca] lg:right-10 lg:top-8">
          <SocialLinks />
        </div>
        ...
        <div className="flex w-full flex-1 flex-col items-center justify-center">
          <div className="flex w-full justify-center">
            <div className="w-full max-w-[414px]">{children}</div>
          </div>
        </div>
      </div>
    </div>
