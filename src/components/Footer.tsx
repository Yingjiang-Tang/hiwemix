      ...
      <div className="absolute bottom-[30px] left-0 right-0 flex flex-col items-center gap-[10px]">
        ...
        <div className="flex items-center justify-center">
          {[
            ...
            { href: "https://www.facebook.com/profile.php?id=61550592422623", label: "Facebook", Icon: FacebookIcon },
            { href: "https://www.instagram.com/haiwenduan?igsh=eGd2c2Fkbnplazl1", label: "Instagram", Icon: InstagramIcon },
          ].map(({ href, label, Icon }) => (
            <a
              key={label}
              href={href}
