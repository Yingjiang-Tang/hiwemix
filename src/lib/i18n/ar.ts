...
const dict_ar = dict({
    ...
    navMyFormulas: "وصفاتي",
    navCompare: "مقارنة",
    cancel: "إلغاء",
    saveFormula: "حفظ الوصفة",
    savedFormula: "محفوظة",
    saveFormulaDialogTitle: "حفظ الوصفة",
    saveFormulaNameLabel: "الاسم",
    saveFormulaNamePlaceholder: "مثال: تويوتا | 040 أبيض ممتاز",
    saveFormulaSuccess: "تم حفظ الوصفة",
    saveFormulaFail: "فشل الحفظ، حاول مرة أخرى",
    saveRequireLogin: "يرجى تسجيل الدخول لحفظ الوصفات",
    myFormulasTitle: "وصفاتي",
    myFormulasEmpty: "لا توجد وصفات محفوظة",
    ...
    compareGrams: "جم/100جم",
    compareOnlyIn: "فقط في",
