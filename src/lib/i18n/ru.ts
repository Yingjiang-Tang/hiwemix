...
const dict_ru = dict({
    ...
    heroSubtitle: "Надёжная платформа покрасочных формул для кузовных цехов по всему миру. Находите точные смесевые формулы по марке, году или коду цвета за секунды.",
