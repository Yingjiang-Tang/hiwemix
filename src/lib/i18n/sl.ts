...
const dict_sl = dict({
    ...
    navMyFormulas: "Moje formule",
    navCompare: "Primerjaj",
    cancel: "Prekliči",
    saveFormula: "Shrani formulo",
    savedFormula: "Shranjeno",
    saveFormulaDialogTitle: "Shrani formulo",
    saveFormulaNameLabel: "Ime",
    saveFormulaNamePlaceholder: "npr. Toyota | 040 Super bela",
    saveFormulaSuccess: "Formula shranjena",
    saveFormulaFail: "Shranjevanje ni uspelo, poskusite znova",
    saveRequireLogin: "Za shranjevanje formul se prijavite",
    myFormulasTitle: "Moje formule",
    myFormulasEmpty: "Ni shranjenih formul",
    ...
    addToCompare: "Dodaj v primerjavo",
    inCompare: "V primerjavi",
    addedToCompare: "Dodano v primerjavo",
    removedFromCompare: "Odstranjeno iz primerjave",
    compareEmpty: "Seznam primerjave je prazen",
    compareEmptyHint: "Odprite formule in tapnite Primerjaj, da jih dodate sem",
    compareGrams: "g/100g",
    compareOnlyIn: "Samo v",
