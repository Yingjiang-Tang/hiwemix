...
const dict_nl = dict({
    ...
    tdsSearchPlaceholder: "Gidsen zoeken...",
    tdsCategories: "Categorieën",
    tdsAllCategories: "Alle categorieën",
    tdsListLabel: "Gidsenlijst",
    tdsSelectHint: "Selecteer links een gids",
    ...
    navColorLibrary: "Pigmenten",
    navFavorites: "Favorieten",
    removeFavorite: "Verwijderen",
    favoritesTitle: "Mijn favorieten",
    favoritesEmpty: "Nog geen favorieten",
    favoritesEmptyHint: "Tik op het hart bij elke formule om deze hier op te slaan",
    favoritesSearchPlaceholder: "Kleurcode, naam of merk zoeken...",
    navTds: "Documenten",
    ...
    tabColorInfo: "Kleurinformatie", manufacturerLabel: "Fabrikant", originLabel: "Herkomst",
    carModelLabel: "Automodel", processLabel: "Proces", versionLabel: "Versie",
    weight: "Gewicht", accum: "Cumulatief", massTone: "Masstint",
    totalWeightLabel: "Totaal", pearlPaintLabel: "Parelverf", groundPaintLabel: "Grondverf",
