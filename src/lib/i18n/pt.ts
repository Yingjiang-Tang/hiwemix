...
const dict_pt = dict({
    ...
    heroSubtitle: "Plataforma confiável de fórmulas de pintura para oficinas de carroceria em todo o mundo. Encontre fórmulas de mistura precisas por marca, ano ou código de cor em segundos.",
