...
const dict_fr = dict({
    ...
    navMyFormulas: "Mes Formules",
    navCompare: "Comparer",
    cancel: "Annuler",
    saveFormula: "Enregistrer la formule",
    savedFormula: "Enregistrée",
    ...
    saveFormulaSuccess: "Formule enregistrée",
    saveFormulaFail: "Échec de l'enregistrement, réessayez",
    saveRequireLogin: "Connectez-vous pour enregistrer des formules",
    myFormulasTitle: "Mes Formules",
    myFormulasEmpty: "Aucune formule enregistrée",
