...
const config: Config = {
 ...
 "bg-emphasis": "rgb(var(--bg-emphasis, 229 229 229) / )",
 "bg-default": "rgb(var(--bg-default, 255 255 255) / )",
 "bg-subtle": "rgb(var(--bg-subtle, 245 245 245) / )",
 "bg-muted": "rgb(var(--bg-muted, 250 250 250) / )",
 "bg-inverted": "rgb(var(--bg-inverted, 23 23 23) / )",

 "bg-info": "rgb(var(--bg-info, 219 234 254) / )",
 "bg-success": "rgb(var(--bg-success, 220 252 231) / )",
 "bg-attention": "rgb(var(--bg-attention, 255 237 213) / )",
 "bg-warning": "rgb(var(--bg-warning, 254 249 195) / )",
 "bg-error": "rgb(var(--bg-error, 254 226 226) / )",

 "border-emphasis":
 "rgb(var(--border-emphasis, 163 163 163) / )",
 "border-default":
 "rgb(var(--border-default, 212 212 212) / )",
 "border-muted": "rgb(var(--border-muted, 245 245 245) / )",
 "border-subtle":
 "rgb(var(--border-subtle, 229 229 229) / )",

 "content-inverted":
 "rgb(var(--content-inverted, 255 255 255) / )",
 "content-muted":
 "rgb(var(--content-muted, 163 163 163) / )",
 "content-subtle":
 "rgb(var(--content-subtle, 115 115 115) / )",
 "content-default":
 "rgb(var(--content-default, 64 64 64) / )",
 "content-emphasis":
 "rgb(var(--content-emphasis, 23 23 23) / )",

 "content-info": "rgb(var(--content-info, 37 99 235) / )",
 "content-success":
 "rgb(var(--content-success, 22 163 74) / )",
 "content-attention":
 "rgb(var(--content-attention, 234 88 12) / )",
 "content-warning":
 "rgb(var(--content-warning, 202 138 4) / )",
 "content-error": "rgb(var(--content-error, 220 38 38) / )",
 },
 dropShadow: {
